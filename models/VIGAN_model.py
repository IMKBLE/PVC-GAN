...
#        self.loss_clustering2 =  self.commonloss(self.q_i2,self.target_i.view(1,10))
        ...
        self.loss_clustering = self.loss_com + 1*self.loss_AE #+self.loss_clustering1 + self.loss_clustering2 
...
#        Cyc_B = self.loss_cycle_B.data[0]
        AE = self.loss_AAE.data[0]
        AE_GAE = self.loss_GAE.data[0]
#        CLU_loss = self.loss_clustering.data[0]
        ALL_loss = self.loss_AE.data[0]
        if self.opt.identity > 0.0:
